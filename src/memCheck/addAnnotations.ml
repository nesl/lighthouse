...
let annotations = (Hashtbl.create 5)

class addAnnotationsVisitor = object (self)
  inherit nopCilVisitor

end

let addAttributes (gl: global list) (g: global) =
...
let feature : featureDescr = {
  ...
  fd_doit = 
    ...
    (function (f:file) ->
      ...
      let aaVisitor = new addAnnotationsVisitor in
        iterGlobals f (addAttributes f.globals)
