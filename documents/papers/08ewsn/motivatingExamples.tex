...
\code{ker\_malloc} and \code{ker\_free}, related to their C namesakes
...
mid-December 2005.  
%
This revision expanded the functionality of \code{loader.c} and broke the code
in figure~\ref{fig:leak} into individual functions to handle module insertion
requests and module removal requests.
%
Unfortunately, as our analysis found, \code{mod\_op} continued to be leaked on
