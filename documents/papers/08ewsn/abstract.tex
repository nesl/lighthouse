...
programmers to mismanage resources, for example through leaked resources
or improper resource sharing.  
%
...
%
Design is driven by the desire for static, simple, scalable, and
...
We have instantiated our approach as a tool to ensure proper management
of dynamically allocated memory in programs written on top of SOS, a
