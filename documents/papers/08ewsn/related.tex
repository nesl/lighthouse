...
\mynote{We can significantly shorten this discussion of SOS's memory system.
Probably two short sentences.}
...
\mynote{Roy: This also needs to be tightened up a bit.}
...
\cite{archer07interface}



\mynote{ROY: Rough first cut at adding Engler.}
%
...
\mynote{Roy: Need to add in discussion of heine03pldi.  This is a tough
one that does a very nice job in direction very similar us.  Key
differences to highlight are our ability to detect dereferencing of
dangling pointers and our modeling of persistent stores.}
