...
\mynote{I think we should add in a reference or two to John Regehr's
work.  He is doing some similar work to statically analyze code for
sensor networks (using CIL for that matter).  For example, "Memory
Safety and Untrusted Extensions for TinyOS".}
